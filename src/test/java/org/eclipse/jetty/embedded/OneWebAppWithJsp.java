...
public class OneWebAppWithJsp
{
    public static void main( final String[] args ) throws Exception
    {
        ...
        webapp.setContextPath("/rememberme");
        String aaa;
        boolean bbb;
        if (false) {
        aaa = "target/webapp-0.1-SNAPSHOT.war";
        bbb = true;
        } else {
        	aaa = "src/main/webapp";
        	bbb = false;
        }
        final File warFile = new File( aaa );
        if (!warFile.exists())
        {
        ...
        loginService.setName( "file" );
        loginService.setConfig( "src/etc/realm.properties" );
